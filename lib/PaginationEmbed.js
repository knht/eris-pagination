...
class PaginationEmbed {
     ...
     * @property {Boolean} options.cycling If back to rist page when you click on next in last page or click last page when you click on back in first page. Defaults to: false
