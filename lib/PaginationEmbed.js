...
class PaginationEmbed {
     ...
     * @property {Boolean} options.toEndStart If back to rist page when you click on next in last page or click last page when you click on back in first page. Defaults to: false
    ...
    constructor(message, pages = [], options = {}) {
        ...
        this.toEndStart = options.toEndStart    || false
            ...
            switch (event.emoji.name) {
                ...
                case this.back: {
                    ...
                    if (this.page > 1) {
                        this.page--;
                        this.update();
                    }else if (this.page === 1 && this.toEndStart === true){
                ...
                case this.forth: {
                    ...
                    if (this.page < this.pages.length) {
                        this.page++;
                        this.update();
                    }else if (this.page === this.pages.length && this.toEndStart === true){
                        this.page = 1;
                        this.update();
                    }
