...
class PaginationEmbed {
     ...
     * @param {Boolean} [options.showPageNumbers] Whether or not to show the current page index over the embed. Defaults to: true
     * @param {Boolean} [options.extendedButtons] Whether or not to show extended control buttons besides standard pagination (First & Last page, deleting)
     * @param {Boolean} [options.cycling] Cycle through all embeds jumping from the first page to the last page on going back and from the last page to the first page going forth. Defaults to: false
     * @param {Number} [options.maxMatches] How often the reaction handler should listen for a reaction (How often the paginator can be used). Defaults to: 50. Maximum: 100
     * @param {Number} [options.timeout] How long the paginator should work before the reaction listener times out. Defaults to: 300000ms (5 minutes). Maximum: 900000ms (15 minutes)
     * @param {String} [options.deleteButton] Emoji which should be used as the delete button. This MUST be a unicode emoji! Defaults to: 🗑
     * @param {String} [options.firstButton] Emoji which should be used as the first page button. This MUST be a unicode emoji! Defaults to: ⏮
     * @param {String} [options.lastButton] Emoji which should be used as the last page button. This MUST be a unicode emoji! Defaults to: ⏭
     * @param {String} [options.backButton] Emoji which should be used as the back button. This MUST be a unicode emoji! Defaults to: ⬅
     * @param {String} [options.forthButton] Emoji which should be used as the forth button. This MUST be a unicode emoji! Defaults to: ➡
     * @param {Number} [options.startPage] Which page of the submitted embed array shoulb be shown first. Defaults to: 1 (The 1st page / element in the array)
     */
...
module.exports = {
     ...
     * @param {String} [options.forthButton] Emoji which should be used as the forth button. This MUST be a unicode emoji! Defaults to: ➡
     * @param {Number} [options.startPage] Which page of the submitted embed array shoulb be shown first. Defaults to: 1 (The 1st page / element in the array)
     * @returns {Promise<Message>} The message object used to invoke the Embed Paginator
     */
